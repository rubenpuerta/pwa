...
// Share API
if (navigator.share) {
  console.log("El navagador sopoorta SHARE API");
  ...
  timeline.on("click", "li", function() {
    ...
    if (tipo === "mapa") {
      sharedOpts.text = "Mapa";
      sharedOpts.url = `https://www.google.com/maps/"${lat},${lng},15z`;
    }
  ...
  console.log("El navagador NO sopoorta SHARE API");
}
